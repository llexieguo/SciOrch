...
class OfflineReinforceConfig(TrainArgumentsMixin, HfTrainingArguments):
    ...
    kl_estimator: str = 'k1'  # 'k1', 'k3', 'gspo', or 'ppo_clip' (legacy alias for pg_loss_type=ppo_clip + k1 KL)
    # Policy gradient form: 'auto' (= derive from kl_estimator, back-compat),
    # 'vanilla' (-A * logπ) or 'ppo_clip' (PPO-style clipped ratio).
    # Setting pg_loss_type='ppo_clip' together with kl_estimator='k3' enables PPO-clip + k3 KL.
    pg_loss_type: str = 'auto'
